...
export default function CraftingPage() {
  return (
    <PageLayout
      ...
      subtitle="SUBCrafting & Recipes"
      icon={<Hammer className="w-5 h-5 text-[var(--text-gold)]" />}
    >
      <div className="text-center py-16">
        <div className="w-16 h-16 mx-auto mb-5 rounded-sm border border-[var(--border-gold-dim)] bg-gradient-to-br from-[#1a2030] to-[#141c2c] flex items-center justify-center">
          <Hammer className="w-8 h-8 text-[var(--border-gold)]" />
        </div>
        <h2 className="font-cinzel text-xl font-bold text-[var(--text-gold)] mb-3">Crafting & Recipes</h2>
