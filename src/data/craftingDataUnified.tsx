...
export const allCraftingItems: CraftingEntry[] = [
  ...
  // MATERIAL PROCESSING
  // ═══════════════════════════════════════════════════════════
  { name: 'Metal Bar Smelting', category: 'Material Processing', type: 'Smelting', materials: 'Ore + Charcoal', source: 'Smelter / Blast Furnace', desc: 'Convert raw ores (Copper, Iron, Tin, Silver) into metal bars for crafting.', rarity: 'Common' },
  { name: 'Coffee Processing', category: 'Material Processing', type: 'Processing', materials: 'Raw Coffee Beans', source: 'Coffee Drum Roaster', desc: 'Roast raw coffee beans for brewing drinks.', rarity: 'Common' },
  { name: 'Glass Processing', category: 'Material Processing', type: 'Smelting', materials: 'Sand x2 + Soda Ash x1', source: 'Smelter', desc: 'Smelt sand into glass for windows, bottles, and laboratory equipment.', rarity: 'Common' },
  { name: 'Farm Soil Production', category: 'Material Processing', type: 'Processing', materials: 'Dirt + Organic Matter', source: 'Farmer NPC', desc: 'Create fertile soil for farming plots and gardens.', rarity: 'Common' },
  { name: 'Charcoal Production', category: 'Material Processing', type: 'Burning', materials: 'Wood Log x3', source: 'Charcoal Kiln', desc: 'Burn wood into charcoal. Essential fuel for smelting and cooking.', rarity: 'Common' },
  { name: 'Bone Key Crafting', category: 'Material Processing', type: 'Crafting', materials: 'Bone Fragment x5 + Shroud Core x1', source: 'Collector NPC', desc: 'Craft Bone Keys to unlock Hollow Halls dungeon doors.', rarity: 'Rare' },
  { name: 'Coffee Bean Processing', category: 'Material Processing', type: 'Processing', materials: 'Coffee Cherries', source: 'Farmer NPC', desc: 'Process harvested coffee cherries into raw coffee beans.', rarity: 'Common' },
  { name: 'Purified Water Production', category: 'Material Processing', type: 'Processing', materials: 'Water + Charcoal Filter', source: 'Improved Water Well', desc: 'Filter and purify water for alchemy and cooking.', rarity: 'Common' },
  { name: 'Glass Production', category: 'Material Processing', type: 'Smelting', materials: 'Sand x3 + Limestone x1', source: 'Smelter', desc: 'Alternative glass production method using limestone.', rarity: 'Common' },
  { name: 'Wool Processing', category: 'Material Processing', type: 'Textile', materials: 'Raw Wool x2', source: 'Spinning Machine', desc: 'Process raw wool into yarn for textile production.', rarity: 'Common' },
  { name: 'Brick Production', category: 'Material Processing', type: 'Firing', materials: 'Clay x3', source: 'Kiln', desc: 'Fire clay into durable bricks for construction.', rarity: 'Common' },
  { name: 'Tar Production', category: 'Material Processing', type: 'Burning', materials: 'Wood Log x5', source: 'Charcoal Kiln', desc: 'Produce tar as a byproduct of charcoal making. Used for waterproofing.', rarity: 'Common' },
];

/**
 * Entries NOT already covered by the guide sections in craftingData.tsx.
 * The sub-pages render the curated guide content; only these extras are
 * appended as cards so nothing is duplicated.
 */
export const craftingSubExtras: Record<string, string[]> = {
  'crafting-stations': [
    'Spinning Machine', 'Seedbed', 'Seafood Grill', 'Coffee Drum Roaster',
    'Coffee Brewery', 'Butter Churn', 'Kitchen', 'Mill', 'Sawblade',
    'Woodworking Bench', 'Stone Cutter',
  ],
  'weapon-recipes': [
    'Wooden Arrow x10', 'Improved Glider', 'Iron Arrow x10', 'Steel Arrow x10',
    'Fire Arrow x10', 'Ice Arrow x10', 'Explosive Arrow x10', 'Ectoplasm Arrow x10',
  ],
  'food-recipes': [
    'Cooked Fish', 'Honey Glazed Fish', 'Butter',
  ],
  'material-processing': [
    'Metal Bar Smelting', 'Coffee Processing', 'Glass Processing',
    'Farm Soil Production', 'Charcoal Production', 'Bone Key Crafting',
    'Coffee Bean Processing', 'Purified Water Production', 'Glass Production',
    'Wool Processing', 'Brick Production', 'Tar Production',
  ],
};
